(() => {
    ...
    function digitsCounter() {
        ...
        function digitsCountersAnimate(digitsCounter) {
            ...
            const duration = parseFloat(digitsCounter.dataset.digitsCounterSpeed) ? parseFloat(digitsCounter.dataset.digitsCounterSpeed) : 2e3;
    ...
    window.onload = () => {
        ...
        document.querySelectorAll(".slider-video__slide").forEach((videoBox => {
            observer.observe(videoBox);
        }));
        document.addEventListener("click", (function(e) {
            const parentEl = e.target.closest(".slider-video__slide");
            if (parentEl) {
